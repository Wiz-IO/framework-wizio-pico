/*
    ...
    https://github.com/pschatzmann/pico-arduino/tree/main/Arduino/SoftwareSerial
...
void setup() {
  ss.begin(115200, PICO_DEFAULT_UART_TX_PIN , PICO_DEFAULT_UART_RX_PIN );
}
...
public:
    ...
    void begin(uint baud = 115200, int txPin = -1, int rxPin = -1)
    {
        this->baud = baud;
